...
public class imsuperman extends JFrame {
    public static void main(String[] args) {
        ...
        JScrollPane scrollPane = new JScrollPane(fileEditTextArea, JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED, JScrollPane.HORIZONTAL_SCROLLBAR_AS_NEEDED);
...
//                        System.out.println("파일을 만듬");
                ...
                fileEdit.add(scrollPane);
                scrollPane.setPreferredSize(new Dimension(frame.getBounds().width - 10, frame.getBounds().height - 35));
